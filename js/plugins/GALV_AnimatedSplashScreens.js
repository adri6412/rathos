...
Scene_Boot.loadSystemImages = function() {
    ...
    for (var i = 0; i < Galv.ASPLASH.splashImgs.length; i++) {
		console.log(Galv.ASPLASH.splashImgs[i].image);
...
SceneManager.goto = function(sceneClass) {
	if (!Galv.ASPLASH.splashed && $dataActors && !DataManager.isBattleTest()) sceneClass = Scene_SplashScreens; // if no splash has played this boot, steal scene
